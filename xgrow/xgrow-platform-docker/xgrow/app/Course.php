...
class Course extends Model
{
    ...
    protected $fillable = [
        ...
        'restrict_date', 'restrict_plan', 'restrict_start', 'restrict_finish', 'is_experience', 'has_offer_link', 'offer_link', 'is_calendar', 'calendar_month', 'calendar_year'
    ];
    ...
    {
        return $this->hasMany(Module::class)->with('class:id,title as className,module_id');
    }
}
