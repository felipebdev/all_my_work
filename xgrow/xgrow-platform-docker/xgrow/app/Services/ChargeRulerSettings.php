...
class ChargeRulerSettings
{
    ...
    public static function defaultChargesForSubscription(?string $platformId = null, bool $isActive = true)
    {
        ...
        return collect([
            ...
            self::newRule($platformId, $type, 3, $isActive, 20, Email::CONSTANT_EMAIL_RECURRENCE_PAYMENT_RETRY_FAILED),
     ...
     * @return bool
     */
    public static function isCancelRequired(int $emailConstant): bool
    {
        $includesCancel = [
            Email::CONSTANT_EMAIL_RECURRENCE_PAYMENT_FAILED_SUBSCRIPTION_CANCEL,
        ];
