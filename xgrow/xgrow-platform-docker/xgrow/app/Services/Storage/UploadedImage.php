...
class UploadedImage
{
    ...
    private \Illuminate\Http\UploadedFile $favicon;
     ...
     */
    public function __construct(string $platformId, UploadedFile $uploadedImage, ?FilesystemAdapter $disk = null, $isFavicon = false)
    {
