...
class CountryCodeIso3166
{
    ...
    public static function fromAlpha2ToAlpha3($code): ?string
    {
        $countries = CountryCodeIso3166::ALPHA2_TO_ALPHA3;
