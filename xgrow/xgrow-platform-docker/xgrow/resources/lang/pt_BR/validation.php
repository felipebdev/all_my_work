...
return [
    ...
    */
    ...
    'uploaded'             => 'O limite de upload é de 5 Mb.',
    'url'                  => 'O campo :attribute tem um formato inválido.',
    'url_ssl'                  => 'O campo :attribute deve ser uma url com https.',
    ...
    */
    ...
    'attributes' => [
        ...
        'age'                       => 'idade',
        'body'                      => 'conteúdo',
        'checkout_layout'           => 'layout do checkout',
        'checkout_url_terms'        => 'link dos termos de uso',
        'city'                      => 'cidade',
        'country'                   => 'país',
        ...
        'last_name'                 => 'sobrenome',
        'message'                   => 'mensagem',
        'message_success_checkout'  => 'mensagem de agradecimento',
        'minute'                    => 'minuto',
        'mobile'                    => 'celular',
        'month'                     => 'mês',
        'name'                      => 'nome',
        ...
        'time'                      => 'hora',
        'title'                     => 'título',
        'type_plan'                 => 'tipo de pagamento',
        'url_checkout_confirm'      => 'url de confirmação',
        'username'                  => 'usuário',
        'year'                      => 'ano',
    ],
