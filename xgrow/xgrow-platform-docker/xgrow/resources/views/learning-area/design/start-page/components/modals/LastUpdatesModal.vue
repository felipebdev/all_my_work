<template>
    ...
    <ConfirmModal :is-open="modal">
        <Row class="text-start w-100">
            <Col>
            <Title is-form-title icon="fas fa-newspaper" icon-color="#FFFFFF" icon-bg="#3f4450" class="m-0">
                Novidades
            </Title>
            <hr>
            </Col>
            ...
            <Subtitle>
                Escolha a quantidade de itens que você quer mostrar.
            </Subtitle>
            </Col>
            <Col>
            <Select id="section" :options="itensOptions" v-model.number="item.newsCount"
        ...
        <div class="modal-body__footer">
            ...
            <DefaultButton text="Salvar" status="success" icon="fas fa-check" @click="$emit('closeModal', false)" />
        </div>
    </ConfirmModal>
</template>
...
export default {
    name: "LastUpdatesModal",
    components: { Select, Row, DefaultButton, ConfirmModal, Subtitle, Title, Col },
    props: {
