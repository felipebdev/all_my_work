<div class="card-integrate">
    <div class="left-card">
        <div class="title-card">
            <img class="img-integration-icon" src="{{ asset('xgrow-vendor/assets/img/octadesk-icon.png') }}" alt="">
            <h2>Octadesk</h2>
        </div>
    ...
    <div class="right-card">
        @if (!empty($id))
            ...
            <div class="bottom-card">
                <a href="javascript:void(0)" class="btn-modal btn-integration-edit" 
                    ...
                    data-provider="octadesk"
                    data-href="octadesk-modal">
        ...
        @else
            <div class="top-card">
                <a class="btn-conectar btn-modal" data-href="octadesk-modal">Conectar</a>
            </div>
        @endif
    </div>
</div>