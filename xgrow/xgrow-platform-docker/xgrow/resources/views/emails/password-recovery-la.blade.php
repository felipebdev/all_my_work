...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2a2e39" style="border-radius:5px;">
    ...
    <tr style="background-color:#ffffff;border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
        <td colspan="2" style="border-bottom-right-radius:10px;border-bottom-left-radius:10px;padding:15px;">
            <p style="padding:0;margin:0">Olá {{$name}}!</p>
            <br/>
            <p style="padding:0;margin:0">Você recebeu esse email porque nós recebemos um requisição de redefinição de
                senha de sua conta.</p>
            <br/>
            ...
            <br/>
            <p style="padding:0;margin:20px 0 0 0;">Esse link de redefinição se expirará em 30 minutos.</p>
            <br/>
            <p style="padding:0;margin:0;">Se você não solicitou uma redefinição de senha, nenhuma ação adicional será
                necessária.</p>
            <br/>
        </td>
    </tr>
...
{{-- <html style="width: 100%">
    <body style="width:100%;display:flex;flex-direction:column;background-color:#2a2e39">
        ...
        <main style="width:100%;height:100vh;background-color:#ffffff;border-radius:10px;padding:15px;
            ...
            <p style="padding:0;margin:0">Você recebeu esse email porque nós recebemos um requisição de redefinição de senha de sua conta.</p><br/>
            <a href="{{ $url }}" style="padding:10px 20px;background-color:#93bc1e;border-radius:5px;
                                color:#ffffff;font-weight:bold;text-decoration:none;">
                Redefinir senha
            </a><br/>
            <p style="padding:0;margin:20px 0 0 0;white-space:pre-warp;">Esse password link de redefinição se expirará em 60 minutos.</p><br/>
            <p style="padding:0;margin:0;white-space:pre-warp;">Se você não solicitou uma redefinição de senha, nenhuma ação adicional será necessária.</p><br/>
        </main>
