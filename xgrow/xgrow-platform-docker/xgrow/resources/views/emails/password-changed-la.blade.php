...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2a2e39" style="border-radius:5px;">
    ...
    <tr style="background-color:#ffffff;border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
        <td colspan="2" style="border-bottom-right-radius:10px;border-bottom-left-radius:10px;padding:15px;">
            ...
            <br/>
            <p style="padding:0;margin:0">Você recebeu esse email porque nós recebemos uma redefinição de senha de sua
                conta.</p>
            <br/>
            <p style="padding:0;margin:0">Clique no link abaixo para ir até a comunidade e basta colocar seu email e sua
                nova senha.</p>
            <br/>
            ...
            <br/>
            <p style="padding:0;margin:20px 0 0 0;">Se você não alterou sua senha, mande um email para nosso
                suporte.</p>
            <br/>
        </td>
    </tr>
