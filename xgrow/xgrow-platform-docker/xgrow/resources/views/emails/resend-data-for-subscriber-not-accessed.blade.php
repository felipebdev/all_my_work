...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2a2e39" style="border-radius:5px;">
    ...
    <tr style="background-color:#ffffff;border-bottom-right-radius:10px;border-bottom-left-radius:10px;">
        <td colspan="2" style="border-bottom-right-radius:10px;border-bottom-left-radius:10px;padding:15px;">
            <p style="padding:0;margin:0;color: #E8E8E8; font-family: 'Open Sans','sans-serif';">Olá, {{ $name }} tudo bem?</p>
            <br/>
            <p style="padding:0;margin:0;color: #E8E8E8; font-family: 'Open Sans','sans-serif';">Verificamos que você ainda não acessou seu produto {{$plan}}.</p>
            <br/>
            <p style="padding:0;margin:0;color: #E8E8E8; font-family: 'Open Sans','sans-serif';">Para acessar basta clicar no link abaixo e fazer o seu login com os dados
                recebidos anteriormente.</p>
            <br/>
            <div style="display: flex">
                <a href="{{ $url }}"
                   style="padding:10px 20px;background-color:#93bc1e;border-radius:5px;color:#ffffff;
