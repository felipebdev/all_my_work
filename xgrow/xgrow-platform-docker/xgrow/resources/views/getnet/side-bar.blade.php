<div class="card">
    <div class="card-header" style="text-align: right;background-color: #F1F1F1;">
        <small class="form-text text-muted">POWERED BY <img src="https://site.getnet.com.br/wp-content/uploads/2018/04/btn_logotipo.png" style="width:80px;height: 25px;border-radius: 6px;">
