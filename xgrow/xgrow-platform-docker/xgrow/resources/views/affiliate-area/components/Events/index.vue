    ...
    <Table id="eventsTable">
      <template v-slot:title>
        <div class="d-flex flex-column">
          ...
          <Row>
            <Subtitle
              >Veja todos os eventos associados à sua afiliação.</Subtitle
            >
          </Row>
        </div>
      </template>
            ...
            <Row>
              ...
              <Col sm="12" md="4" lg="4" xl="4" class="mb-4">
                <Multiselect
                  ...
                  :searchable="true"
                  mode="tags"
                  placeholder="Digite o nome ou ID do afiliado ou selecione..."
                  :canClear="true"
                  @change="updateAdvancedFilters"
                >
                  <template v-slot:noresults>
      ...
      <template v-slot:header>
        <th
          v-for="header in ['Tipo', 'Origem', 'Data', 'Plataforma e plano']"
          :key="header"
        >
          {{ header }}
        </th>
      ...
      <template v-else v-slot:body>
        <tr>
          <td colspan="11">Não há eventos associados à sua afiliação</td>
        </tr>
      </template>
...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      const url = affiliateEventsList.replace("platform_id", this.platformId);
