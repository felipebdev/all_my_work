...
{	
	...
	$.fn.tagsInit=function(option){
		...
		if($tagdiv.data('input')){
			...
			//创建input
			var oInput=$("<input type='text' class='form-control' placeholder='adicionar hashtags' value='"+note+"' title='"+note+"' class='tag-input tag-input-blur' id='"+tagper+"_tag_input' />").appendTo(oDiv);
			//给input添加事件
