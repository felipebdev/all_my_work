...
Route::group([
    ...
    'middleware' => ['web', 'auth2f', 'audit.route', 'verify.ip', 'role:integration'],
    'prefix' => '/apps/integrations',
    'as' => 'apps.integrations.'
], function () {
    Route::get('/', ['as' => 'index', 'uses' => 'AppIntegrationController@index']);
    Route::get('/new', 'AppIntegrationController@newIndex')->name('integrations.index.new');
    Route::get('new-plan-product/{id}', '\App\Http\Controllers\ProductController@isolatedProductPlan')->name('products.new.plan.product');


    Route::post('/', ['as' => 'store', 'uses' => 'AppIntegrationController@store']);
    Route::get('/{integration}', ['as' => 'show', 'uses' => 'AppIntegrationController@show']);
    Route::get('/edit/{integration}', ['as' => 'edit', 'uses' => 'AppIntegrationController@edit']);
