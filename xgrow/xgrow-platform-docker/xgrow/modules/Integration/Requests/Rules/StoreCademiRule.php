...
class StoreCademiRule extends BaseRule
{
    public function getRules(Request $request) {
        return [
            'description' => 'max:190',
            'is_active' => 'boolean',
            'code' => ['required', Rule::in([CodeEnum::CADEMI])],
            'type' => ['required', Rule::in([TypeEnum::CADEMI])],
    ...
    public function getAttributes() {
        return [
            ...
            'is_active' => 'ativo',
            'api_webhook' => 'url da api cademi',
            'api_key' => 'chave da api cademi',
        ];
    }
