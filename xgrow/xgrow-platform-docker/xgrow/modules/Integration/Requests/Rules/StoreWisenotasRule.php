...
class StoreWisenotasRule extends BaseRule
{
    public function getRules(Request $request) {
        return [
            'description' => 'max:190',
            'is_active' => 'boolean',
            'code' => ['required', Rule::in([CodeEnum::WISENOTAS])],
            'type' => ['required', Rule::in([TypeEnum::WISENOTAS])],
    ...
    public function getAttributes() {
        return [
            ...
            'is_active' => 'ativo',
            'api_webhook' => 'link do webhook wisenotas',
