...
class InputDateTime extends Input
{
	...
	{
		parent::__construct($id, $name, $class, 'datetime', $value, $label, '<i class="fas fa-calendar"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
	}
    ...
    {
        return view('components.ui.input-date-time');
    }
}
