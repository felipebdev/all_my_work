...
class InputDate extends Input
{
	...
	{
		parent::__construct($id, $name, $class, 'date', $value, $label, '<i class="fas fa-calendar"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
	}
