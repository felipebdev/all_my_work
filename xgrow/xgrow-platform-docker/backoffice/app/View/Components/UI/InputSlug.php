...
class InputSlug extends Input
{
	...
	{
		parent::__construct($id, $name, $class, 'slug', $value, $label, '<i class="fas fa-globe"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
	}
    ...
    {
        return view('components.ui.input-slug');
    }
}
