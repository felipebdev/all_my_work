...
class InputName extends Input
{
	...
	{
		parent::__construct($id, $name, $class, 'name', $value, $label, '<i class="fas fa-user"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
    ...
    {
        return view('components.ui.input-name');
    }
}
