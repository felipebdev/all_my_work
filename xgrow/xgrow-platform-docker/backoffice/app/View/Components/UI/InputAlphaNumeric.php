...
class InputAlphaNumeric extends Input
{
	/**
    ...
    {
	    parent::__construct($id, $name, $class, 'alphanumeric', $value, $label, '<i class="fas fa-info"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
    }
    ...
    {
        return view('components.ui.input-alpha-numeric');
    }
}
