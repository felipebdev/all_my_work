...
class InputFloat extends InputNumber
{
    ...
    {
	    parent::__construct($id, $name, $class, 'float', $value, $label, '<i class="fas fa-sort-numeric-up"></i>', $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
    ...
    {
        return view('components.ui.input-float');
    }
}
