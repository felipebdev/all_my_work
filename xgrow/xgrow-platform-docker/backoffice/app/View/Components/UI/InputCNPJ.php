...
class InputCNPJ extends Input
{
	/**
	 * InputCNPJ constructor.
	 *
	 * @param string $id
	 * @param string $name
	 * @param string $class
	...
	{
		parent::__construct($id, $name, $class, 'cnpj', $value, $label, '<i class="fas fa-id-card-alt"></i>', $append, $maxlength, $required, 'cnpj', 'cnpj', $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
	}
    ...
    {
        return view('components.ui.input-cnpj');
    }
}
