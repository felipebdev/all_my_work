...
class InputTime extends Input
{
	...
	{
		parent::__construct($id, $name, $class, 'time', $value, $label, '<i class="fas fa-clock"></i>', $append, $maxlength, $required, $validation, $serverValidation, $tip, $state, $schema, $prependIcon, $group, $optional, $readonly);
	}
