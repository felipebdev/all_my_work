...
@push('after-scripts')
    ...
    <script type="module" src="{{ asset('/js/client-transactions.js') }}"></script>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            @include('client-transactions._form-filter')
            ...
            <div class="table-responsive m-t-30">
                <table id="report-table" class="table table-bordered">
                    ...
                    <tr class="header-info">
                        ...
                        <th colspan="{{$totalColumns['client']}}" class="client">Cliente</th>
                        <th colspan="{{$totalColumns['payment']}}" class="payment">Pagamento</th>
                    </tr>
