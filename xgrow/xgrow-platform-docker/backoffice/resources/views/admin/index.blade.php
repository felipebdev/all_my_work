...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-end">
            <a href="{{ url('/admin/create') }}" class="btn btn-rounded btn-outline-primary">
                <i class="fa fa-star"></i> Novo Administrador
            </a>
        </div>
        <div class="table-responsive m-t-30">
            ...
            <table id="platform-table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                ...
                                <form method="POST"
                                    onsubmit="return confirm('Deseja deletar a plataforma: {{addslashes($user->name)}} ?')"
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center">Não há administradores cadastrados</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
