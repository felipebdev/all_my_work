                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div>
                                <h3>{{ $chart2Data['title'] }}</h3>
                                <h6 class="card-subtitle">{{ $chart2Data['subtitle'] }}</h6>
                            </div>
                                <div class="ml-auto">
                                    <ul class="list-inline">
                                        @forelse($chart2Data['seriesTitles'] as $key=>$serieTitle)
                                        <li>
                                            <h6 class="text-muted"><i class="fa fa-circle mr-1 {{ $chart2Data['seriesClasses'][$loop->iteration -1] }}"></i>
                                                    {{ $serieTitle }}
                                            </h6>
                                        </li>
                                        @empty
...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">{{ $chartSales['title'] }}</h4>
                ...
                <ul class="list-inline mt-4 text-center">
                    @forelse($chartSales['seriesTitles'] as $key=>$serieTitle)
                        <li><i class="fa fa-circle " style="color:{{ $chartSales['colors'][$loop->iteration - 1] }}"></i>  {{ $serieTitle }}</li>
                    @empty
                    <li>
                        <h6 class="text-muted text-danger">
                            <i class="fa fa-circle font-10 m-r-10 "></i>
            ...
            <div class="card-body">
                ...
                <div class="message-box">
                    <div class="message-widget message-scroll">
                        ...
                        <!-- Message -->
                        <a href="#">
                            <div class="user-img"> <img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away float-right"></span> </div>
                            <div class="mail-contnet">
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <img class="card-img-top img-responsive" src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/big/img1.jpg" alt="Card">
            <div class="card-body">
    ...
    <div class="col-lg-4">
        <div class="card">
            <img class="card-img-top img-responsive" src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/big/img2.jpg" alt="Card">
            <div class="card-body">
                <ul class="list-inline font-14">
                    <li class="pl-0">20 May 2016</li>
                    <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
    ...
    <div class="col-lg-4">
        <div class="card">
            <img class="card-img-top img-responsive" src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/big/img4.jpg" alt="Card">
            <div class="card-body">
                <ul class="list-inline font-14">
                    <li class="pl-0">20 May 2016</li>
                    <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
