...
<!-- Vector CSS -->
<link href="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
<!-- Calendar CSS -->
<link href="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/calendar/dist/fullcalendar.css" rel="stylesheet" />
...
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- Calendar JavaScript -->
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/moment/moment.js"></script>
<script src='/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/calendar/dist/fullcalendar.min.js'></script>
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/calendar/dist/jquery.fullcalendar.js"></script>
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/calendar/dist/cal-init.js"></script>
<!-- sparkline chart -->
<script src="/vendor/wrappixel/monster-admin/4.2.1/assets/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="/vendor/wrappixel/monster-admin/4.2.1/monster/js/dashboard4.js"></script>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table browser mt-4 no-border">
                    <tbody>
                    <tr>
                        <td style="width:40px"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/browser/chrome-logo.png" alt=logo /></td>
                        <td>Google Chrome</td>
                        <td class="text-right"><span class="label label-light-info">23%</span></td>
                    </tr>
                    <tr>
                        <td><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/browser/firefox-logo.png" alt=logo /></td>
                        <td>Mozila Firefox</td>
                        <td class="text-right"><span class="label label-light-success">15%</span></td>
                    </tr>
                    <tr>
                        <td><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/browser/safari-logo.png" alt=logo /></td>
                        <td>Apple Safari</td>
                        <td class="text-right"><span class="label label-light-primary">07%</span></td>
                    </tr>
                    <tr>
                        <td><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/browser/internet-logo.png" alt=logo /></td>
                        <td>Internet Explorer</td>
                        <td class="text-right"><span class="label label-light-warning">09%</span></td>
                    </tr>
                    <tr>
                        <td><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/browser/opera-logo.png" alt=logo /></td>
                        <td>Opera mini</td>
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row">
                    <div class=""><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/1.jpg" alt="user" class="img-circle" width="100"></div>
                    <div class="pl-3">
            ...
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-12 mb-4">
                        <h4>Followers</h4></div>
                    <div class="col"><span class="round" data-toggle="tooltip" title="Varun"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/4.jpg" alt="user" width="45"/></span></div>
                    <div class="col"><span class="round" data-toggle="tooltip" title="Alia"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/2.jpg" alt="user" width="45"/></span></div>
                    <div class="col"><span class="round" data-toggle="tooltip" title="Akshay"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/3.jpg" alt="user" width="45"/></span></div>
            ...
            <div class="card-body">
                ...
                <div class="chat-box">
                    ...
                    <ul class="chat-list">
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/1.jpg" alt="user" /></div>
                        ...
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/2.jpg" alt="user" /></div>
                            <div class="chat-content">
                                <h5>Bianca Doe</h5>
                        ...
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="/vendor/wrappixel/monster-admin/4.2.1/assets/images/users/3.jpg" alt="user" /></div>
                            <div class="chat-content">
