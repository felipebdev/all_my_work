<div id="modal-digitalmanagerguru" class="modal-integration modal-integration-two-items">
    <div class="modal-integration-wrapper">
        ...
        <div class="integration-info">
            ...
            <p>
                Reúna tudo o que precisa para otimizar seu negócio online e gerenciar toda a estratégia digital num só
                lugar, com total liberdade de escolha sobre quais serviços e ferramentas utilizar.
            </p>
        ...
        <form action="{{ url('/integracao/store') }}" method="POST">
            ...
            <div class="d-flex form-check form-switch">
                <input class="form-check-input me-2 mb-2" type="checkbox" id="digitalmanagerguru-flag_enable" name="flag_enable" value="1" checked="">
