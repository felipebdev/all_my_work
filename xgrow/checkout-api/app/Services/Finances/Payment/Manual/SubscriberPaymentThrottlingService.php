...
class SubscriberPaymentThrottlingService
{
    ...
    {
        $paymentLogs = $this->paymentLogRepository->getSubscriberTriesByPaymentId($paymentId);
    ...
    {
        $tries = $this->paymentLogRepository->countSubscriberTriesByPaymentId($paymentId);
