...
class Content extends Model
{
    ...
    protected $fillable = ['title', 'subtitle', 'description', 'published', 'published_at', 'thumb_small_id', 'thumb_big_id', 'content_html', 'audio_link', 'video_link', 'external_link', 'has_audio_link', 'has_video_link', 'has_external_link', 'hashtags', 'available_after_content_id', 'expire_in', 'section_id', 'author_id', 'is_featured', 'featured_order', 'course_id', 'module_id', 'is_course', 'likes', 'views', 'comments', 'audio_id', 'order_course'];
