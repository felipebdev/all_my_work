...
{
    public function getSubscribersByStatus($platform_id, $status = NULL)
    {
    ...
    public function getSubscribersStatusByPeriod($platform_id, ?string $start = null, ?string $end = null)
    {
    ...
    {
        return "SELECT a.name, b.filename FROM subscribers a
                LEFT JOIN files b ON a.thumb_id = b.id
                WHERE a.platform_id = '$platform_id'
