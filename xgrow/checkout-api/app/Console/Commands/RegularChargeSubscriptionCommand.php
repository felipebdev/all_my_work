...
class RegularChargeSubscriptionCommand extends Command
{
    protected $signature = 'xgrow:regular-charge:subscription '.
    ...
    protected $description = 'Launches regular (new) subscriptions charge';
