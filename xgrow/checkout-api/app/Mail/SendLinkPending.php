...
class SendLinkPending extends BaseMail
{
    ...
    {
        parent::__construct($platformId, [$subscriber->email], Email::CONSTANT_EMAIL_LINK_PENDING);
    ...
    public function build()
    {
        ...
        $message = str_replace('##LINK_PENDING##', $this->getLink(), $message);
