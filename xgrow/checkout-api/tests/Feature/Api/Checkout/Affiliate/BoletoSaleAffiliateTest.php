...
use Tests\Feature\Traits\Database\ValidatesBoletoDatabase;
 ...
 */
class BoletoSaleAffiliateTest extends TestCase
{
    ...
    public function test_creditcard_no_coupon_no_orderbump_one_installment()
    {
        ...
        // assert side effects
        $this->assertDatabaseBoleto($subscriberId, $this->salePlanId, $orderCode, 100);
