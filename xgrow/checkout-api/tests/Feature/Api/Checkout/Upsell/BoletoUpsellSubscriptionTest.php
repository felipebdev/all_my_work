...
class BoletoUpsellSubscriptionTest extends TestCase
{
    ...
    public function test_boleto_upsell()
    {
        ...
        $mainResponse = $this->postJson("/api/checkout/{$this->platformId}/{$this->subscriptionPlanId}", [
