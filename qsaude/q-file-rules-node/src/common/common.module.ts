import { appConfig, loggerConfig, throttleConfig, databaseConfig } from '@app/common/configs'
    ...
    return {
      ...
      imports: [
        ...
        OpenTelemetryModule.forRoot({
          applicationName: 'q-file-rules-node',
          traceAutoInjectors: [
            ControllerInjector,
            GuardInjector,
            EventEmitterInjector,
        ...
        DynamooseModule.forRootAsync({
          ...
          useFactory: async (configService: ConfigService) => {
            return {
              aws: {
                region: configService.get<string>('database.region'),
                accessKeyId: configService.get<string>('database.accessKeyId'),
                secretAccessKey: configService.get<string>('database.secretAccessKey')
              },
              local: false
            }
          }
