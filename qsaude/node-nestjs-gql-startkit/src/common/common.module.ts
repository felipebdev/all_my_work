import { appConfig, loggerConfig, throttleConfig, microsservicesUrlConfig } from '@app/common/configs'
...
import { AppConfigService, StrategyExplorerService } from '@app/common/services'
import {
  ActiveHandlesMetric,
...
import { DynamicModule, Module, CacheModule, Global } from '@nestjs/common'
    ...
    return {
      ...
      imports: [
        ...
        OpenTelemetryModule.forRoot({
          applicationName: 'node-nestjs-gql-startkit',
          traceAutoInjectors: [
            ControllerInjector,
            GuardInjector,
            EventEmitterInjector,
      ...
      providers: [StrategyExplorerService, CorrelationIdMiddleware, AppConfigService],
      exports: [StrategyExplorerService, AppConfigService, HttpModule]
    }
  }
}
